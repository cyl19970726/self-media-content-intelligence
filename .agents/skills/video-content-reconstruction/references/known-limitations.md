...
- Targeted evidence capture is bounded by default to 60 frames per action and 180 unique frames per protocol; the gap-free base evidence pack is separate. Very long, fast, or text-dense videos may require justified action splitting, higher-resolution crops, or an explicitly raised cap. Exact-time and byte-identical frames are shared across actions, but perceptually similar frames are not discarded automatically because small UI/text changes may carry meaning.
